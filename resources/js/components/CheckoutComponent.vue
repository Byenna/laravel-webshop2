                    ...
                    <div v-for="userinfo in user_addresses" :key="userinfo.id">
                        <div v-if="userinfo.user_id==user.id">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" id="street" placeholder="Brinkstraat" v-model="userinfo.street" required>
                            </div>

                            <div class="col-sm-4">
                                <label for="house_number" class="form-label">House Number </label>
                                <input type="text" class="form-control" id="house_number" v-model="userinfo.house_number" placeholder="17">
                            </div>

                            <div class="col-md-3">
                                <label for="zip" class="form-label">Zip</label>
                                <input type="text" class="form-control" id="zip" placeholder="" v-model="userinfo.zip_code" required>
                            </div>
